...
namespace DemoBaseXNA
{
    ...
    public sealed class PhysicsSimulatorView
    {
		...
		// MICHAEL ADDED THIS
		public bool EnableAllNonPanelObjects
		{
			set
			{
				EnableAABBView = value;
				EnableContactView = value;
				EnableCoordinateAxisView = value;
				EnableEdgeView = value;
				EnablePinJointView = value;
				EnableRevoluteJointView = value;
				EnableSliderJointView = value;
				EnableSpringView = value;
				EnableVerticeView = value;
			}
		}
		...
		public float LayerDepth
		{
			...
			set
			{
				...
				_aabbLineBrush.Layer = layerDepth;
				_contactCircleBrush.Layer = layerDepth;
				_coordinateAxisLineBrush.Layer = layerDepth;
				_verticeCircleBrush.Layer = layerDepth;
				_edgeLineBrush.Layer = layerDepth;
				_revoluteJointLineBrush.Layer = layerDepth;
				_revoluteJointRectangleBrush.Layer = layerDepth;
				_pinJointLineBrush.Layer = layerDepth;
				_pinJointRectangleBrush.Layer = layerDepth;
				_sliderJointLineBrush.Layer = layerDepth;
				_sliderJointRectangleBrush.Layer = layerDepth;
				_springCircleBrush.Layer = layerDepth;
				_springLineBrush.Layer = layerDepth;
			}
		}
		private float layerDepth = 0;
		// MICHAEL DIDN'D ADD THIS
